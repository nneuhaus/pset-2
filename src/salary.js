...
let Take_home= Initial_minus - (Federal_contribution+State_contribution+Federal_contribution+State_contribution+Medicare_contribution)
Take_home = Take_home.toLocaleString("en", { minimmumFractionDigits: 2, maximumFractionDigits: 2 });

console.log("\nYour take-home pay each check will be $" + Take_home + "0 . \n" );
